...
def printHelp():
	...
	print('            This parameter sets up a circular environment. The enclosed area')
	...
	print('            The parameter <segments> sets the number of walls used to approximate')
	print('            a circular environment, such that a value of 5 creates a pentagon,')
	print('            6 a hexagon, and for large values the arena looks circular\n')
